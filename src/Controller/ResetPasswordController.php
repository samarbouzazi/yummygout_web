...
//        ]);
        if ($this->getUser()==null) {
            $this->addFlash('success', 'Vous allez recevoir les instructions de réinitialisation du mot de passe dans quelques instants. le lien expirera dans 1 heure');
        }
...
//        if ($user == null) {
//            $this->addFlash('reset_password_error', sprintf(
//                'L\'e-mail n\'a pas été trouvé. Veuillez réessayer de réinitialiser votre mot de passe.'
//            ));
//            return $this->redirectToRoute('app_forgot_password_request');
//        }
...
//  $mailer->send($email);
        ...
        $emailContent = 'Bonjour, Vou avez demandé un changement de mot de passe pour votre compte. Pour procéder au changement, merci de cliquer sur le bouton réinitialiser.';
        $emailUrl = '';
